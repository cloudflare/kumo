...
const cases: SelectEvalCase[] = [
	...
	},
	{
		...
		expectedLabels: ["US East (IAD)", "US West (SFO)", "Europe (AMS)", "Asia Pacific (SIN)"],
	},
	{
	...
	},
	{
		...
		expectedLabels: ["R2 bucket", "HTTP endpoint", "Amazon S3", "Azure Blob Storage"],
	},
];
...
describeEval(
	...
	(itEval) => {
		itEval.for(cases)("$name", async ({ task, expectedValues, expectedLabels }, { run }) => {
