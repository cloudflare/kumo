...
export function CodeExample({ code }: CodeExampleProps) {
  return (
    <CodeHighlighted
      className={cn(
        "code-block rounded-none border-0 bg-transparent p-2 [&_pre]:text-base!",
      )}
      code={code}
      lang="tsx"
    />
    ...
    examples: [
      {
        ...
        jsx: (
          <LayerCard className={cn("grid w-full gap-1 p-5")}>
    ...
    examples: [
      ...
      },
      {
        ...
        jsx: (
          <LayerCard>
            <LayerCard.Secondary>
              <span className={cn("capitalize")}>Recent Requests</span>
            </LayerCard.Secondary>
            <LayerCard.Primary />
          </LayerCard>
        ),
      },
      {
        ...
        jsx: (
          <LayerCard>
            <LayerCard.Secondary>
              <span className={cn("uppercase")}>Recent Requests</span>
            </LayerCard.Secondary>
            <LayerCard.Primary />
          </LayerCard>
        ),
...
<Text as="strong" DANGEROUS_className="font-bold">required</Text>`,
        jsx: (
          <div className={cn("grid gap-1")}>
            <Text as="h3" DANGEROUS_className={cn("text-lg font-bold")}>
              Account settings
            </Text>
            <Text>
              This action is{" "}
              <Text as="strong" DANGEROUS_className={cn("font-bold")} size="lg">
                required
              </Text>
              .
            </Text>
  ...
  <Button>Configure</Button>
        ...
        jsx: (
          <LayerCard className={cn("w-full p-5")}>
            <div className={cn("grid gap-6")}>
              <div className={cn("grid gap-1.5")}>
                ...
                <Text
                  variant="secondary"
                  DANGEROUS_className={cn("text-pretty")}
                >
                  Measure site traffic without changing your code.
                </Text>
              </div>
              <Button className={cn("justify-self-start")}>Configure</Button>
            </div>
          </LayerCard>
        ),
      },
        ...
        jsx: (
          <LayerCard className={cn("w-full p-5")}>
            <div className={cn("grid gap-4")}>
              ...
              <Text variant="secondary" DANGEROUS_className={cn("text-pretty")}>
                Measure site traffic without changing your code.
              </Text>
              <Button className={cn("justify-self-start")}>Configure</Button>
            </div>
  ...
  },
  {
    ...
    examples: [
      {
        variant: "good",
        exampleCode: `<LayerCard className="px-5 py-3">...</LayerCard>`,
        jsx: (
          <LayerCard className={cn("px-5 py-3")}>
    ...
    examples: [
      {
        ...
        jsx: (
          <button
            type="button"
            className={cn(
              "cursor-pointer rounded-lg bg-kumo-base px-4 py-2 font-medium ring ring-kumo-line hover:bg-kumo-tint",
            )}
          >
            Hover me
          </button>
      ...
      },
      {
        ...
        jsx: (
          <button
            type="button"
            className={cn(
              "cursor-pointer rounded-lg bg-kumo-base px-4 py-2 font-medium ring ring-kumo-line transition-colors duration-300 hover:bg-kumo-tint",
            )}
          >
            Hover me
          </button>
    ...
    examples: [
      {
        ...
        jsx: (
          <LayerCard className={cn("w-full shadow-md ring ring-kumo-line")}>
            <LayerCard.Primary className={cn("grid gap-1 p-5")}>
              <Text as="h3" variant="heading3">
                Workers API
              </Text>
      ...
      },
      {
        ...
        jsx: (
          <LayerCard
            className={cn("w-full border border-kumo-line shadow-md ring-0")}
          >
            <LayerCard.Primary className={cn("grid gap-1 p-5 ring-0")}>
              <Text as="h3" variant="heading3">
                Workers API
              </Text>
              <Text variant="secondary">Last deployed 4 minutes ago</Text>
  ...
  <div className="rounded-lg">...</div>
        ...
        jsx: (
          <div className={cn("size-40 overflow-hidden")}>
            <div
              className={cn(
                "size-80 rounded-[48px] bg-kumo-tint p-4 ring-2 ring-inset ring-kumo-line",
              )}
            >
              <div
                className={cn(
                  "size-full rounded-[32px] bg-kumo-base ring-2 ring-inset ring-kumo-line",
                )}
              />
            </div>
          </div>
        ...
        jsx: (
          <div className={cn("size-40 overflow-hidden")}>
            ...
            >
              <div
                className={cn(
                  "size-full rounded-[48px] bg-kumo-base ring-2 ring-inset ring-kumo-line",
                )}
              />
            </div>
          </div>
  ...
  <Text>Text that may wrap onto multiple lines</Text>
        ...
        jsx: (
          <div className={cn("flex max-w-64 items-start gap-2")}>
            <span className={cn("flex h-lh shrink-0 items-center")}>
  ...
  <Text>Text that may wrap onto multiple lines</Text>
        ...
        jsx: (
          <div className={cn("flex max-w-64 items-center gap-2")}>
            <WarningIcon
              aria-hidden="true"
        ...
        jsx: (
          <Text size="lg">
            ...
            <Text
              as="code"
              variant="mono"
              DANGEROUS_className={cn("text-[0.9em]")}
            >
              wrangler.toml
            </Text>{" "}
            to continue.
        ...
        jsx: (
          <Text size="lg">
            ...
            <Text
              as="code"
              variant="mono"
              DANGEROUS_className={cn("text-[1em]")}
            >
              wrangler.toml
            </Text>{" "}
            to continue.
    ...
    examples: [
      {
        ...
        jsx: (
          <LayerCard className={cn("h-56 w-full overflow-auto")}>
            <div
              className={cn(
                "sticky top-0 z-10 flex items-center justify-between border-b border-kumo-line bg-kumo-base px-3 py-2",
              )}
            >
              <Text bold>API tokens</Text>
              <Button size="sm">Create</Button>
            </div>
            <div className={cn("grid gap-4 p-3")}>
      ...
      },
      {
        ...
        jsx: (
          <LayerCard className={cn("h-56 w-full overflow-auto")}>
            <div
              className={cn(
                "sticky top-0 z-10 flex items-center justify-between bg-kumo-base px-3 py-2",
              )}
            >
              <Text bold>API tokens</Text>
              <Button size="sm">Create</Button>
  ...
  <LayerCard>...</LayerCard>
        ...
        jsx: (
          <div className={cn("grid w-full")}>
            <div className={cn("flex h-10 items-center")}>
              <Text as="h3" bold>
                Recent Requests
              </Text>
            </div>
            <LayerCard>
              <LayerCard.Secondary
                className={cn(
                  "grid h-12 grid-cols-3 items-center gap-4 px-3 py-0",
                )}
              >
                <Text bold size="sm">
                  Time
              ...
              <LayerCard.Primary
                className={cn(
                  "grid h-10 grid-cols-3 items-center gap-4 px-3 py-0",
                )}
              >
  ...
  <LayerCard>...</LayerCard>
        ...
        jsx: (
          <LayerCard className={cn("w-full")}>
            <div className={cn("flex h-10 items-center px-3")}>
              <Text as="h3" bold>
                Recent Requests
              </Text>
            </div>
            <LayerCard>
              <LayerCard.Secondary
                className={cn("grid h-12 grid-cols-3 gap-4 px-3 py-0")}
              >
                <Text bold>Time</Text>
  ...
  },
  {
    ...
    description:
      "Prefer using `gap-*` with `grid` or `flex` to create space around elements. Margins should generally be limited to negative values to reduce space.",
    examples: [
      {
        variant: "good",
        jsx: (
  ...
  {
    id: "navigation",
    title: "Do not use `window.open` if possible",
    description:
      "`window.open()` should only be used to open external links after a mutation. Use Kumo's `Link` component for navigation from elements and `react-router`'s navigation API for internal programmatic navigation.",
    examples: [
      {
        variant: "good",
        jsx: (
          <CodeExample
            code={`<Link href="/workers/services">View Workers</Link>

const navigate = useNavigate();
navigate("/workers/services");`}
          />
        ),
      },
      {
        ...
        jsx: (
          <CodeExample
            code={`<Button
  onClick={() =>
    window.open("/workers/services", "_blank", "noopener")
  }
>
  View Workers
</Button>`}
  ...
  },
  {
    ...
    title: "Never use JavaScript for responsive styling",
    description:
      "Do not use `isMobile()` solely for the purpose of applying responsive styles. Use Tailwind's responsive variants or CSS media queries instead.",
    examples: [
      {
        variant: "good",
        jsx: (
          <CodeExample
            code={`<LayerCard className="grid gap-4 p-4 md:grid-cols-2">
  <Text>Requests</Text>
  <Text>Errors</Text>
</LayerCard>`}
          />
...
<LayerCard className={isMobile ? "grid-cols-1" : "grid-cols-2"}>
  <Text>Requests</Text>
  <Text>Errors</Text>
</LayerCard>`}
          />
  ...
  {
    id: "behavioral-tests",
    title: "Never test for the existence of class names",
    description:
      "Do not write tests that asserts the existence of certain class names. These tests are brittle and do not reflect the end user experience.",
    examples: [
      {
        variant: "good",
        jsx: (
          <CodeExample
            code={`render(<Button>Deploy</Button>);
...
expect(onDeploy).toHaveBeenCalledOnce();`}
      ...
      },
      {
        ...
        jsx: (
          <CodeExample
            code={`const { container } = render(<Button>Deploy</Button>);

expect(container.querySelector(".bg-kumo-brand")).toBeTruthy();
expect(container.firstChild).toHaveClass("font-medium");`}
  ...
  {
    id: "component-mocking",
    title: "Never mock components in tests",
    description:
      "Tests should test the integration path. Only localization components, route params, and API calls should be mocked.",
    examples: [
      {
        variant: "good",
        jsx: (
  ...
  http.post("/api/deployments", () =>
    HttpResponse.json({ status: "deployed" }),
  ),
);
