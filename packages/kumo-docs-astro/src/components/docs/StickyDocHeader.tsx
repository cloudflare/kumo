...
export function StickyDocHeader({
  ...
  return (
    <>
      ...
      <header
        ref={headerRef}
        className="sticky top-12 z-10 flex h-12 border-b border-kumo-line bg-kumo-canvas lg:top-0"
      >
        <div className="flex min-w-0 flex-1 items-center justify-between px-4 md:px-6 lg:border-r lg:border-kumo-line lg:px-4">
          <div
            className={cn(
