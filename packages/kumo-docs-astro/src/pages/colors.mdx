  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>Border/ring color for all surface edges (10% black in light mode, 10% white in dark mode). Use for both flat surfaces (e.g. <code>LayerCard</code>) and elevated surfaces alongside a shadow.</td>
      </tr>
    </tbody>
  </table>
</div>
