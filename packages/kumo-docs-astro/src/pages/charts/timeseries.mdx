...
<p>
  A stress test with many long-named series and large values — exercises tooltip
  truncation, number formatting, and positioning.
</p>

  <ComponentExample demo="ManySeriesChartDemo">
    <ManySeriesChartDemo client:visible />
  </ComponentExample>
</ComponentSection>
