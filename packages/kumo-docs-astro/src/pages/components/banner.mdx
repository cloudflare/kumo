...
Use `size="sm"` when banners need to be integrated within dialogs and other tight spaces. If these banners need to have an action button, they should be render inline with the description.
