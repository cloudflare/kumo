...
Use `size="sm"` when banners need to be integrated within dialogs and other tight spaces. When an action is needed, it should be rendered inline with the description.
