...
<ComponentSection>
  ...
  <p>
    ...
    When <code class="rounded bg-kumo-control px-1 py-0.5 text-sm">disabledReason</code> is provided,
    an info icon with a tooltip explains why the option is unavailable.
  </p>
...
<ComponentSection>
  ...
  <p>
    ...
    accepts descriptor objects with <code class="rounded bg-kumo-control px-1 py-0.5 text-sm">disabled</code> and{" "}
    <code class="rounded bg-kumo-control px-1 py-0.5 text-sm">disabledReason</code> alongside
    plain string values.
  </p>
