...
<h4 class="mb-3 text-base font-medium">Warning</h4>
<ComponentExample demo="BadgeWarningDemo">
  <BadgeWarningDemo client:visible />
</ComponentExample>

<h4 class="mb-3 text-base font-medium">Warning Subtle</h4>
<ComponentExample demo="BadgeWarningSubtleDemo">
  <BadgeWarningSubtleDemo client:visible />
</ComponentExample>
