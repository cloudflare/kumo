...
| Token                 | Purpose                             |
| --------------------- | ----------------------------------- |
| `bg-kumo-canvas`      | Page canvas background          |
| `bg-kumo-recessed`    | Recessed/segmented container        |
| `bg-kumo-base`        | Primary card/control surface        |
| `bg-kumo-active`      | Active/selected state fill          |
| `bg-kumo-elevated`    | Legacy elevated surface (deprecated) |
| `bg-kumo-overlay`     | Legacy overlay surface (deprecated) |
| `bg-kumo-contrast`    | High-contrast background (inverted) |
| `bg-kumo-control`     | Legacy control background (deprecated) |
| `bg-kumo-fill`        | Legacy muted fill (deprecated)      |
| `bg-kumo-fill-hover`  | Legacy fill hover state (deprecated) |
| `bg-kumo-tint`        | Legacy subtle tint (deprecated)     |
| `bg-kumo-interact`    | Legacy interactive background       |
...
| Token | Purpose |
|-------|---------|
| `border-kumo-fill` | Legacy border (deprecated) |
| `border-kumo-line` | Legacy subtle separator line (deprecated) |
| `ring-kumo-ring` | Default ring (input borders) |
| `ring-kumo-active` | Active state ring |
