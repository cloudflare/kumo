      ...
      <div
        className={cn(
          ...
          isIndividualFocus
            ...
            : "overflow-hidden shadow-xs ring ring-kumo-ring focus-within:ring-kumo-ring",
          className,
        )}
      >
        {children}
  ...
  return (
    <InputExternal
      ...
      className={cn(
        ...
        "grow px-2",
        isIndividualFocus
          ? "relative ring ring-kumo-ring first:rounded-l-[inherit] last:rounded-r-[inherit] focus:z-1 focus:outline"
