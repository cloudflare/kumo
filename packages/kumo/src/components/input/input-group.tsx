      ...
      <div
        className={cn(
          ...
          isIndividualFocus
            ...
            : "overflow-hidden shadow-xs ring ring-kumo-line focus-within:ring-kumo-focus focus-within:ring-1",
          className,
        )}
      >
        {children}
  ...
  return (
    <InputExternal
      ...
      className={cn(
        ...
        "grow px-2",
          isIndividualFocus
            ? "relative ring ring-kumo-line first:rounded-l-[inherit] last:rounded-r-[inherit] focus:z-1 focus:outline-none focus:ring-kumo-focus focus:ring-1"
            : "focus:border-kumo-focus focus:ring-kumo-focus focus:ring-1",
            props.className,
        )}
      />
  );
    ...
    <ButtonExternal
      ...
      size={context?.size}
        className={cn(
          ...
          isIndividualFocus &&
            "relative ring ring-kumo-line first:rounded-l-[inherit] last:rounded-r-[inherit] focus:z-1 focus:ring-kumo-focus/50 kumo-focus-visible-emphasis",
            className,
        )}
      >
      {children}
