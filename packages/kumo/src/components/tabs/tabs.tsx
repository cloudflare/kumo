      ...
      >
        {items.map((tab) => (
          <TabsPrimitive.Tab
            ...
            render={tab.render}
            className={cn(
              "relative z-2 flex cursor-pointer items-center rounded bg-transparent text-base whitespace-nowrap focus:outline-none focus:ring-kumo-focus/50 focus-visible:outline-none kumo-focus-visible-emphasis",
              isSegmented &&
