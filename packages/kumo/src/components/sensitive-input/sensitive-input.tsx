    ...
    const containerContent = (
      <>
        ...
        <BaseInput
          ...
          className={cn(
            "w-full border-0 bg-transparent p-0 text-kumo-default ring-0 outline-none placeholder:text-kumo-placeholder disabled:cursor-not-allowed disabled:text-kumo-subtle",
            size === "xs" && "pr-5",
            size === "sm" && "pr-6",
            size === "base" && "pr-8",
            size === "lg" && "pr-10",
