  ...
  return (
    <FlowStateContext.Provider value={flowStateContextValue}>
      ...
      >
        ...
        {/* Vertical scrollbar */}
        {canScrollY && (
          <div className="absolute top-1 right-1 bottom-1 w-1.5 rounded-full bg-kumo-line/50 opacity-0 group-hover:opacity-100">
            <motion.div
        ...
        {canScrollX && (
          <div className="absolute right-1 bottom-1 left-1 h-1.5 rounded-full bg-kumo-line/50 opacity-0 group-hover:opacity-100">
            <motion.div
