      ...
      <BaseSwitch.Root
        ...
        render={(rootProps, state) => {
          ...
          const trackClassName = cn(
            ...
            "focus:outline-none focus-visible:ring-kumo-brand focus-visible:ring-2",
      ...
      >
        <BaseSwitch.Root
          ...
          render={(rootProps, state) => {
            ...
            const trackClassName = cn(
              "relative inline-flex items-center ring cursor-pointer border-none p-0",
              "focus:outline-none focus:ring-kumo-focus/50 focus-visible:ring-kumo-focus focus-visible:ring-2",
              "transition-colors duration-150 ease-out motion-reduce:transition-none",
              "disabled:cursor-not-allowed disabled:opacity-50",
              s.track,
              squircleRadius,
