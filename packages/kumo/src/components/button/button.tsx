...
export const KUMO_BUTTON_VARIANTS = {
  ...
  variant: {
    ...
    "secondary-destructive": {
      classes:
        "bg-kumo-base !text-kumo-danger ring not-disabled:hover:border-secondary! not-disabled:hover:bg-kumo-base disabled:bg-kumo-base/50 disabled:!text-kumo-danger/70 ring-kumo-ring data-[state=open]:bg-kumo-base",
      description:
