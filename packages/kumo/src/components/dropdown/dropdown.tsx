...
>(({ className, inset, children, icon: IconComponent, ...props }, ref) => (
  <DropdownMenuPrimitive.SubmenuTrigger
    ...
    className={cn(
      ...
      "px-2 py-1.5", // spacing
      "focus:bg-kumo-tint focus:ring-kumo-focus/50 focus-visible:ring-kumo-focus focus-visible:ring-2", // focus state
  ...
  (
    ...
    return (
      <DropdownMenuPrimitive.Item
        ref={ref}
        className={cn(
          "relative flex cursor-default items-center rounded-md px-2 py-1.5 text-base outline-hidden select-none focus:text-kumo-default focus:ring-kumo-focus/50 focus-visible:ring-kumo-focus focus-visible:ring-2 data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-kumo-overlay",
          inset && "pl-8",
    ...
    return (
      <DropdownMenuPrimitive.LinkItem
        ...
        className={cn(
          ...
          "focus:text-kumo-default focus:ring-kumo-focus/50 focus-visible:ring-kumo-focus focus-visible:ring-2 data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-kumo-overlay",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-default items-center rounded-sm py-1.5 pr-2 pl-8 text-base outline-hidden transition-colors select-none focus:bg-kumo-tint focus:text-kumo-default focus:ring-kumo-focus/50 focus-visible:ring-kumo-focus focus-visible:ring-2 data-disabled:pointer-events-none data-disabled:opacity-50",
      className,
    )}
    checked={checked}
    {...props}
