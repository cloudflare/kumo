    ...
    <div>
      <div className="mb-3 text-center">
        <input
          ...
          className={cn(
            "w-full rounded-md border-none bg-transparent py-1.5 text-center font-semibold text-kumo-default transition-all duration-200 focus:outline-none focus:ring-kumo-focus/50",
            sizeConfig.textSize,
          )}
          onBlur={(e) => {
