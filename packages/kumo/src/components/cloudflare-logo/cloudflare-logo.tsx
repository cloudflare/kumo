...
/** Cloudflare brand orange color */
export const CLOUDFLARE_ORANGE = "#F48120";
/** Cloudflare brand yellow color */
export const CLOUDFLARE_YELLOW = "#FAAD3F";
/** Cloudflare brand text gray color */
export const CLOUDFLARE_TEXT_GRAY = "#404041";

// =============================================================================
// SVG Path Data (for custom implementations)
// =============================================================================

/** SVG path for the main orange cloud shape */
export const CLOUDFLARE_GLYPH_ORANGE_PATH =
...
/** SVG path for the yellow sun/ray element */
export const CLOUDFLARE_GLYPH_YELLOW_PATH =
...
/** SVG path for the "CLOUDFLARE" wordmark text */
export const CLOUDFLARE_WORDMARK_PATH =
...
/** Full logo orange cloud path (positioned for full logo viewBox) */
export const CLOUDFLARE_FULL_LOGO_ORANGE_PATH =
...
/** Full logo yellow sun path (positioned for full logo viewBox) */
export const CLOUDFLARE_FULL_LOGO_YELLOW_PATH =
...
/** ViewBox for glyph-only variant */
export const CLOUDFLARE_GLYPH_VIEWBOX = "0 0 49 22";

/** ViewBox for full logo variant */
export const CLOUDFLARE_FULL_LOGO_VIEWBOX = "0 0 101.4 33.5";
